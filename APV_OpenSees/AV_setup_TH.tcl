...
for { set igrx [expr $gmshift+1] } { $igrx <= $numgrmot } { incr igrx } {
    ...
    set inFile "GMs/$grmotnameX.AT2";
    puts $inFile;
    set outFileX "GMs/$grmotnameX.acc";
    puts $outFileX;
    ReadSMDFile $inFile $outFileX $numdatperln dttrans nptstrans;
	
    set inFile "GMs/$grmotnameY.AT2";
    puts $inFile;
    set outFileY "GMs/$grmotnameY.acc";
    puts $outFileY;
    ReadSMDFile $inFile $outFileY $numdatperln dttrans nptstrans;
	
    set inFile "GMs/$grmotnameZ.AT2";
    puts $inFile;
    set outFileZ "GMs/$grmotnameZ.acc";
    puts $outFileZ;
    ReadSMDFile $inFile $outFileZ $numdatperln dttrans nptstrans;
...
set spmass [expr 0.0143/386.4]
# define NODAL COORDINATES
# Abutment 47
node 1	  0.0	0.0  0.0;
node 2	 60.0   0.0  0.0;
node 3	120.0	0.0  0.0;
node 4	  0.0  60.0  0.0;
node 5	 60.0  60.0  0.0;
node 6	120.0  60.0  0.0;
node 7	  0.0 120.0  0.0;
node 8	 60.0 120.0  0.0;
node 9	120.0 120.0  0.0;

node 11	  0.0	0.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 12	 60.0   0.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 13	120.0	0.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 14	  0.0  60.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 15	 60.0  60.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 16	120.0  60.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 17	  0.0 120.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 18	 60.0 120.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
node 19	120.0 120.0  48.0 -mass $spmass $spmass $spmass 0.0 0.0 0.0;
...
geomTransf PDelta 1 1 0 0;                # transformation for columns, update later considering the actual
geomTransf Linear 2 0 0 1;                # transformation for beams
geomTransf Linear 3 0 0 1;                # transformation for girders



set wtimber 4.5e-08; # computed as (0.150kip/386.4)/(12 inch)^3
...
element elasticBeamColumn 1 1 11 $Acol1 $Ecol1 $Gcol1 $Jcol1 $Iycol1 $Izcol1 1 -mass [expr $wtimber*$Acol1] -cMass;
element elasticBeamColumn 2 2 12 $Acol2 $Ecol2 $Gcol2 $Jcol2 $Iycol2 $Izcol2 1 -mass [expr $wtimber*$Acol2] -cMass;
element elasticBeamColumn 3 3 13 $Acol1 $Ecol1 $Gcol1 $Jcol1 $Iycol1 $Izcol1 1 -mass [expr $wtimber*$Acol1] -cMass;
element elasticBeamColumn 4 4 14 $Acol2 $Ecol2 $Gcol2 $Jcol2 $Iycol2 $Izcol2 1 -mass [expr $wtimber*$Acol2] -cMass;
element elasticBeamColumn 5 5 15 $Acol3 $Ecol3 $Gcol3 $Jcol3 $Iycol3 $Izcol3 1 -mass [expr $wtimber*$Acol3] -cMass;
element elasticBeamColumn 6 6 16 $Acol2 $Ecol2 $Gcol2 $Jcol2 $Iycol2 $Izcol2 1 -mass [expr $wtimber*$Acol2] -cMass;
element elasticBeamColumn 7 7 17 $Acol1 $Ecol1 $Gcol1 $Jcol1 $Iycol1 $Izcol1 1 -mass [expr $wtimber*$Acol1] -cMass;
element elasticBeamColumn 8 8 18 $Acol2 $Ecol2 $Gcol2 $Jcol2 $Iycol2 $Izcol2 1 -mass [expr $wtimber*$Acol2] -cMass;
element elasticBeamColumn 9 9 19 $Acol1 $Ecol1 $Gcol1 $Jcol1 $Iycol1 $Izcol1 1 -mass [expr $wtimber*$Acol1] -cMass

# beams
element elasticBeamColumn 11 1 2 $Ab $Eb $Gb $Jb $Iyb $Izb 2 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 12 2 3 $Ab $Eb $Gb $Jb $Iyb $Izb 2 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 13 4 5 $Ab $Eb $Gb $Jb $Iyb $Izb 2 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 14 5 6 $Ab $Eb $Gb $Jb $Iyb $Izb 2 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 15 7 8 $Ab $Eb $Gb $Jb $Iyb $Izb 2 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 16 8 9 $Ab $Eb $Gb $Jb $Iyb $Izb 2 -mass [expr $wtimber*$Ab] -cMass;

# girders
element elasticBeamColumn 17 1 4 $Ab $Eb $Gb $Jb $Iyb $Izb 3 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 18 4 7 $Ab $Eb $Gb $Jb $Iyb $Izb 3 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 19 2 5 $Ab $Eb $Gb $Jb $Iyb $Izb 3 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 20 5 8 $Ab $Eb $Gb $Jb $Iyb $Izb 3 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 21 3 6 $Ab $Eb $Gb $Jb $Iyb $Izb 3 -mass [expr $wtimber*$Ab] -cMass;
element elasticBeamColumn 22 6 9 $Ab $Eb $Gb $Jb $Iyb $Izb 3 -mass [expr $wtimber*$Ab] -cMass;
...
set GMfatt [expr 386.4*$SF];
timeSeries Path 1 -dt $dttrans -filePath $outFileX -factor [expr $GMfatt]
timeSeries Path 2 -dt $dttrans -filePath $outFileY -factor [expr $GMfatt]
timeSeries Path 3 -dt $dttrans -filePath $outFileZ -factor [expr $GMfatt]
...
#recorders
recorder Node -file Data/nodesAx-$igrx.out -timeSeries 1 -time -node 11 12 13 14 15 16 17 18 19 -dof 1 accel
recorder Node -file Data/nodesAy-$igrx.out -timeSeries 2 -time -node 11 12 13 14 15 16 17 18 19 -dof 2 accel
recorder Node -file Data/nodesAz-$igrx.out -timeSeries 3 -time -node 11 12 13 14 15 16 17 18 19 -dof 3 accel
